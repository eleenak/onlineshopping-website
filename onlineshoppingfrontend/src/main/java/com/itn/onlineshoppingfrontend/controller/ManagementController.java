...
import com.itn.onlineshoppingfrontend.Validator.ProductValidator;
import com.itn.onlineshoppingfrontend.util.FileUploadUtility;
...
public class ManagementController {
	...
	public String handleProductActivation(@PathVariable int id) {
		...
		// is fetching the product from database
		Product product = productDAO.get(id);
		boolean isActive = product.isActive();

		// changing activation process based on the value of active field
	...
	// returning categories for request mapping
