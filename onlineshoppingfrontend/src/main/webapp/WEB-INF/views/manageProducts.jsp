		...
		<hr/>
			...
			<table id="adminProductsTable" class="table table-condensed table-bordered">
				...
				<tbody>
					<tr>
						<td>4</td>
						<td><img class="adminDataTableImg" src="${contextRoot}/resources/images/PRD310B81A51D.jpg" alt="Macbook Pro"/></td>
						<td>Macbook Pro</td>
						<td>3</td>
						<td>Nrs</td>
						<td>54000</td>
						...
						<td><a href="${contextRoot}/manage/4/product" class="btn btn-warning">Edit</a></td>
	...
	<!-- modal header -->
		...
		<div class="modal-body">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<sf:textarea cols="10" rows="5" path="description" id="category_description" class="form-control"/>
				</div>
			</div>
			<div class="form-group">
				<label for="description" class="control-label col-md-4">Category Description</label>
